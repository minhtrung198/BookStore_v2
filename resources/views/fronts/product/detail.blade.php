...
<div class="col-md-8" style="margin-top: -296px;">
            
<div class="product-detail-top">
            <div class="row align-items-center">
                <div class="col-lg-4">
                    <div class="product-slider-single normal-slider">
                        <img src="{{asset('img/khoahoc2.jpg')}}" alt="Producdt Image">
                    </div>
                ...
                <div class="col-md-6">
                    <form action="{{route('save-cart')}}" method="post">
                        ...
                        <div class="product-content">
                            ...
                            <div class="price">
                                <span>Giá: {{($products->price)." ".'VNĐ'}}</span>
                            </div>
                                <div class="quantity">
                                    <div class="qty">
                                    <h3>Số lượng:</h3>
                        ...
                        <div class="action">
                            <button type="submit" class="btn btn-default cart"><i class="fa fa-shopping-cart"></i>Thêm Vào Giỏ</button>
