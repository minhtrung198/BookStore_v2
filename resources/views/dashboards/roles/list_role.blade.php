...
<h1>List Roles</h1>
<div class="but1">
	<a href="{{route('dashboards.roles.create_role')}}" class="btn btn-danger">Create</a>
	<a href="{{route('dashboards.roles.record_role')}}" class="btn btn-info">Record</a>
</div>
<table class="table table-hover">
	...
	<tbody>
		...
		<tr>
			...
			<td>{{$role->name}}</td>
			<td>
				<a href="{{route('dashboards.roles.edit_role', $role->id)}}">
