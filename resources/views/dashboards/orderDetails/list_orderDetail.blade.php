...
<div class="but1">
	<a href="{{route('dashboards.orderDetails.create_orderDetail')}}" class="btn btn-danger">Create</a>
	<a href="#" class="btn btn-info">Record</a>
</div>
<table class="table table-hover">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<a href="{{route('dashboards.orderDetails.edit_orderDetail', $orderDetail->id)}}">
